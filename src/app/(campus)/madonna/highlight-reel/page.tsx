...
export const metadata = {
  ...
  description: "Crew-curated reel of Madonna sports highlights, played back to back.",
};
...
async function safe<T>(work: Promise<T>, fallback: T): Promise<T> {
  try {
    ...
    console.error("[madonna-highlight-reel] data failed:", error);
    return fallback;
  }
}

export default async function MadonnaHighlightReelPage() {
      ...
      {canManageMedia ? (
        <>
          <DashboardCard
            ...
            description="Publishes straight into Sports Recap and, when ticked, this reel."
